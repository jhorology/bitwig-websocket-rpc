...
var $, assert, chai, utils, wsClose, wsConnect, wsNotify, wsRequest;
...
describe('JSON-RPC 2.0 Specification, see https://www.jsonrpc.org/specification', function() {
  var i, len, ref, results, test;
  ref = [
    {
      name: "One bye one connection",
      connect: false
    },
    {
  ...
  for (i = 0, len = ref.length; i < len; i++) {
    test = ref[i];
    results.push(describe(test.name, function() {
      var ws;
      ws = void 0;
      if (test.connect) {
        before(function() {
          return wsConnect().then(function(conn) {
            ws = conn;
            return this;
          });
        });
      ...
      it('rpc call with positional parameters. id:1', function() {
        return wsRequest(ws, {
          jsonrpc: '2.0',
          method: 'test.sum',
          params: [1, 2],
      ...
      it('rpc call with positional parameters. id:2', function() {
        return wsRequest(ws, {
          jsonrpc: '2.0',
          method: 'test.sum',
          params: [1, 2, 3],
      ...
      it('rpc call with named parameters. mapping params to POJO class. id:3', function() {
        return wsRequest(ws, {
          jsonrpc: '2.0',
          method: 'test.sum',
          params: {
      ...
      it('rpc call with named parameters. mapping params to generic class. id:4', function() {
        return wsRequest(ws, {
          jsonrpc: '2.0',
          method: 'test.repeat',
          params: {
      ...
      it('rpc call of non-existent method. id:6', function() {
        return wsRequest(ws, {
          jsonrpc: '2.0',
          method: 'foobar',
          id: 6
        }, $.expectError).should.become({
          jsonrpc: '2.0',
          error: {
            code: -32601,
      ...
      it('rpc call with invalid JSON.', function() {
        return wsRequest(ws, '{"jsonrpc": "2.0", "method": "fooba", "params": "bar", "baz]', $.expectError).should.become({
          jsonrpc: '2.0',
          error: {
            code: -32700,
            message: 'Parse error'
      ...
      it('rpc call with an empty Array.', function() {
        return wsRequest(ws, [], $.expectError).should.become({
          jsonrpc: '2.0',
          error: {
            code: -32600,
            message: 'Invalid Request'
      ...
      it('rpc call with an invalid Batch (but not empty).', function() {
        return wsRequest(ws, [1], $.expectError).should.become([
          {
            jsonrpc: '2.0',
            error: {
              code: -32600,
      ...
      it('rpc call with invalid Batch.', function() {
        return wsRequest(ws, [1, 2, 3], $.expectError).should.become([
          {
            jsonrpc: '2.0',
            error: {
              code: -32600,
      ...
      return it('rpc call Batch (all notifications).', function() {
        return wsNotify(ws, [
          {
            jsonrpc: '2.0',
            method: 'test.nop'
...
},{"./test-utils":44,"chai":3,"chai-as-promised":2}],43:[function(require,module,exports){
require('./jsonrpc20.spec');

require('./transport.spec');


},{"./jsonrpc20.spec":42,"./transport.spec":45}],44:[function(require,module,exports){
var $, WebSocket, _, _parseResponse, _send, _sendAndResponse, assert, chai, wsClose, wsConnect, wsNotify, wsRequest;
...
// @req request message
// -----------------------------
wsRequest = function(ws, req, assertError) {
  if (ws) {
    // use static onnection
    return _sendAndResponse(ws, req, assertError, false);
  }
...
// @req  notify message
// -----------------------------
wsNotify = function(ws, req, assertError) {
  if (ws) {
    // use static onnection
    return _sendAndResponse(ws, req, assertError, true);
  }
  // use one-by-one connection
  ws = void 0;
  return wsConnect().then(function(conn) {
...
wsConnect = function() {
  return new Promise(function(resolve, reject) {
    ...
    return timer = setTimeout(function() {
      clear();
      return reject(new Error('connection open timeout.'));
    }, $.timeout);
  });
};
...
wsClose = function(ws) {
  return new Promise(function(resolve, reject) {
    ...
    timer = setTimeout(function() {
      clear();
      return reject(new Error('connection close timeout.'));
    }, $.timeout);
    return ws.close();
  });
};

_sendAndResponse = function(ws, req, assertError, notify) {
  return new Promise(function(resolve, reject) {
    var clear, timer;
    timer = void 0;
    clear = function() {
    ...
    _send(ws, req);
    if (notify) {
      return _send(ws, JSON.stringify($.echoRequest));
    }
  });
};

_send = function(ws, message) {
...
_parseResponse = function(res, assertError) {
  var d, data, i, len;
  data = JSON.parse(res);
...
},{"chai":3,"isomorphic-ws":38,"underscore":41}],45:[function(require,module,exports){
var $, assert, chai, utils, wsClose, wsConnect, wsNotify, wsRequest;
...
describe('Transport Module', function() {
  ...
  //     .should.become $.OK
  it('isPlaying.subscrive()', function() {
    return wsNotify(ws, {
      jsonrpc: '2.0',
  ...
  it('isPlaying() convert BooleanValue to primitive. id:2', function() {
    return wsRequest(ws, {
      jsonrpc: '2.0',
  ...
  return it('isPlaying.unsubscrive()', function() {
    return wsNotify(ws, {
      jsonrpc: '2.0',
...
},{"./test-utils":44,"chai":3,"chai-as-promised":2}]},{},[43]);
