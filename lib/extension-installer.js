...
/**
 * Returns default extsion folder.
 * @public
 * @function
 * @param {object} options
 *  - {String} options.extensionDir
...
function _wslWinHomeDir() {
  // Full patch cmd.exe for /etc/wsl.conf [interop] appendWindowsPath = false
  return execSync('wslpath $(/mnt/c/Windiws/system32/cmd.exe /C "echo %USERPROFILE%") 2> /dev/null', {
