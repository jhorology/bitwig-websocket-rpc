...
public class TestImpl implements Test {
  ...
  public void consume(Number a, Number b, Number c) {
    LOG.info(
      "void consume(Number a=" + a + ", Number b=" + b + ", Number c=" + c + ")"
    );
  }
  ...
  public int sum(IntPair pair) {
    LOG.info(
      "sum({left:" + pair.getLeft() + ", right:" + pair.getRight() + "})"
    );
  ...
  public String concat(String a, String b) {
    String result = a + b;
    LOG.info(
      "String concat(String a=" + a + ", String b=" + b + ") = " + result
    );
    return result;
  }
  ...
  public String concat(String... args) {
    String result = Stream.of(args).collect(Collectors.joining());
  ...
  public String repeat(String s, int count) {
    String result = IntStream
      ...
      .collect(Collectors.joining());
    LOG.info(
      "String repat(String s=" + s + ", int count=" + count + ") = " + result
    );
    return result;
  }
